<template>
  <footer class="relative isolate overflow-hidden bg-gray-800">
    <div class="mx-auto max-w-7xl py-12 px-6 md:flex md:items-center md:justify-between lg:px-8">
      ...
      <div class="mt-8 md:order-1 md:mt-0">
        <p class="text-center text-xs leading-5 text-gray-500">&copy; 2023 Biznapps SpA. Todos los derechos reservados.</p>
      </div>
    </div>
  </footer>
</template>
