<template>
  ...
  <div class="relative isolate overflow-hidden pt-14">
      <img src="@/assets/peopleWorking.png" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover" />
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
          <div class="relative rounded-full py-1 px-3 text-sm leading-6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
            Conoce nuestros casos de éxito <a href="/successcases" class="font-semibold text-white"><span class="absolute inset-0" aria-hidden="true" />Ver casos de éxito <span aria-hidden="true">&rarr;</span></a>
          </div>
        </div>
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">¡Bienvenido a Biznapps!</h1>
          <p class="mt-6 text-lg leading-8 text-gray-300">Cubrimos tus necesidades con soluciones innovadoras y de alta calidad.</p>
          <div class="mt-10 flex items-center justify-center gap-x-6">
            <a href="/products" class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400">Nuestros Productos</a>
          </div>
        </div>
      </div>
